...
pub const PROJECT_SIGNATURES: &[(&ProjectType, ProjectSignature)] = &[
    ...
    (&ProjectType::NodeJs, ProjectSignature {
    ...
    (&ProjectType::TypeScript, ProjectSignature {
    ...
    (&ProjectType::React, ProjectSignature {
        required_files: &["package.json"],
        forbidden_files: &[],
        content_patterns: &[
    ...
    (&ProjectType::Vue, ProjectSignature {
        required_files: &["package.json"],
        forbidden_files: &[],
        content_patterns: &[
            ("package.json", r#""vue""#),
    ...
    (&ProjectType::Angular, ProjectSignature {
    ...
    (&ProjectType::Svelte, ProjectSignature {
        required_files: &["package.json"],
        forbidden_files: &[],
        content_patterns: &[
    ...
    // Rust
    (&ProjectType::Rust, ProjectSignature {
    ...
    // Python
    (&ProjectType::Python, ProjectSignature {
    ...
    (&ProjectType::Django, ProjectSignature {
        required_files: &["manage.py", "requirements.txt"],
        forbidden_files: &[],
        content_patterns: &[
            ("manage.py", r#"django-admin"#),
        ],
        confidence: 0.9,
    }),
    
    (&ProjectType::Flask, ProjectSignature {
    ...
    (&ProjectType::FastAPI, ProjectSignature {
    ...
    // Java
    (&ProjectType::Java, ProjectSignature {
    ...
    (&ProjectType::Maven, ProjectSignature {
    ...
    (&ProjectType::Gradle, ProjectSignature {
    ...
    // Go
    (&ProjectType::Go, ProjectSignature {
    ...
    // C/C++
    (&ProjectType::Cpp, ProjectSignature {
    ...
    (&ProjectType::CMake, ProjectSignature {
    ...
    // .NET
    (&ProjectType::DotNet, ProjectSignature {
    ...
    // Ruby
    (&ProjectType::Ruby, ProjectSignature {
    ...
    (&ProjectType::Rails, ProjectSignature {
    ...
    // PHP
    (&ProjectType::Php, ProjectSignature {
    ...
    (&ProjectType::Laravel, ProjectSignature {
    ...
    // Mobile
    (&ProjectType::Android, ProjectSignature {
    ...
    (&ProjectType::Flutter, ProjectSignature {
    ...
    (&ProjectType::ReactNative, ProjectSignature {
        required_files: &["package.json"],
        forbidden_files: &[],
        content_patterns: &[
            ("package.json", r#""react-native""#),
        ],
        confidence: 0.9,
    }),
    
    // Infrastructure
    (&ProjectType::Docker, ProjectSignature {
    ...
    (&ProjectType::Kubernetes, ProjectSignature {
    ...
    (&ProjectType::Terraform, ProjectSignature {
        required_files: &["*.tf"],
        forbidden_files: &[],
        content_patterns: &[
            ("*.tf", r#"resource "#),
    ...
    (&ProjectType::Ansible, ProjectSignature {
    ...
    (&ProjectType::Packer, ProjectSignature {
    ...
    (&ProjectType::Vagrant, ProjectSignature {
    ...
    // Data
    (&ProjectType::Jupyter, ProjectSignature {
    ...
    (&ProjectType::R, ProjectSignature {
    ...
    // Game Development
    (&ProjectType::Unity, ProjectSignature {
    ...
    (&ProjectType::Unreal, ProjectSignature {
    ...
    // Version Control
    (&ProjectType::Git, ProjectSignature {
        required_files: &[".git"],
        forbidden_files: &[],
        content_patterns: &[],
        confidence: 0.95,
    ...
    (&ProjectType::Hg, ProjectSignature {
        required_files: &[".hg"],
        forbidden_files: &[],
        content_patterns: &[],
        confidence: 0.95,
    ...
    (&ProjectType::Svn, ProjectSignature {
        required_files: &[".svn"],
        forbidden_files: &[],
        content_patterns: &[],
        confidence: 0.95,
